...
public class Rfc3339LenientTest {

    private Rfc3339Parser parser;

    @Before
    public void setUp() {
        parser = new Rfc3339Lenient();
    }
    ...
    public void parseOffset() throws ParseException {
        Date unknownOff = parser.parse("1985-04-12t23:20:50-00:00");
        assertEquals(482196050000L, unknownOff.getTime());
    ...
    public void testInternalTzStyle() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        Method getTzStyle = parser.getClass().getDeclaredMethod("getTimezoneStyle", String.class, char[].class);
    ...
    public void parseCalendar() throws ParseException {
        ...
        assertEquals(parser.parseTimezone(timeString), parsed.getTimeZone());
